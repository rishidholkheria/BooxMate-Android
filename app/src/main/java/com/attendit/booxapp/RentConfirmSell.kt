...
import com.attendit.booxapp.RentConfirmSell
...
//            }
    ...
    private fun addRentBook() {
        ...
        if (!TextUtils.isEmpty(rbook_name)) {
            ...
            val book = RentBookModel(rbook_name, rbook_location, rbook_mrp, rbook_offeredprice, rent_id, rbook_category, null, rbook_description, null, null, null, null, "200", "4 months", "500")
